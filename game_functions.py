...
def check_keydown_events(event, ai_settings, screen, ship, bullets):
    ...
    if event.key == pygame.K_RIGHT:
        ...
        bullet_sound = mixer.Sound('C:/Users/USER/GAME_PROJECT/sounds/shot1.wav')
        bullet_sound.play()
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if collisions:
        dead_sound = mixer.Sound('C:/Users/USER/GAME_PROJECT/sounds/dead2.wav')
        dead_sound.play()
    ...
    if len(aliens) == 0:
        #if the entire fleet is detroyed, start a new level
        bullets.empty()
        ...
        wow_sound = mixer.Sound('C:/Users/USER/GAME_PROJECT/sounds/wow.wav')
        wow_sound.play()
...
def check_fleet_edges(ai_settings, aliens):
    """respond if alien has reached edges"""
...
def ship_hit(ai_settings, stats, sb, screen, ship, aliens, bullets):
    ...
    if stats.ships_left > 0:
        ...
        laugh_sound = mixer.Sound('C:/Users/USER/GAME_PROJECT/sounds/laugh.wav')
        laugh_sound.play()
...
def update_aliens(ai_settings, stats, sb, screen, ship, aliens, bullets):
    """check if the fleet os at the edge,
